...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(windowShade,          "#d9d9d9", "#f7fdff", "#333333", "#333333")
    DECLARE_QGC_COLOR(windowShadeDark,      "#bdbdbd", "#f7fdff", "#282828", "#282828")
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#00AAED", "#3a3a3a", "#50bbe6")
    ...
    DECLARE_QGC_COLOR(missionItemEditor,    "#585858", "#00AAED", "#585858", "#00AAED")
    DECLARE_QGC_COLOR(toolStripHoverColor,  "#585858", "#9D9D9D", "#585858", "#50bbe6")
    ...
    DECLARE_QGC_COLOR(toolbarBackground,    "#ffffff", "#ebebeb", "#222222", "#00AAED")
