...
Item {
    ...
    property Fact _tankCapacity:            controller.getParameterFact(-1, "BATT2_CAPACITY", false /* reportMissing */)
    ...
    Column {
        ...
        VehicleSummaryRow {
            ...
            valueText:  _sprayEnabled && _tankCapacity ? _tankCapacity.valueString + " mL" : ""
