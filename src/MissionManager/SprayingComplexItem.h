...
Q_DECLARE_LOGGING_CATEGORY(SprayingComplexItemLog)

class PlanMasterController;
class MissionItem;

class SprayingComplexItem : public TransectStyleComplexItem
 {
     Q_OBJECT
 ...
 public:
    ...
    QString         mapVisualQML        (void) const final { return QStringLiteral("SprayingMapVisual.qml"); }
     QString         presetsSettingsGroup(void) { return settingsGroup; }
     void            savePreset          (const QString& name);
     void            loadPreset          (const QString& name);
     bool            isSurveyItem        (void) const final { return false; }
    ...
    QString             commandName         (void) const final { return tr("Spraying"); }
    ...
    static constexpr const char* jsonComplexItemTypeValue =   "spraying";
    static constexpr const char* jsonV3ComplexItemTypeValue = "spraying";

    static constexpr const char* settingsGroup =              "Spraying";
