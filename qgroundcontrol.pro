...
QGC_APP_NAME        = "FullDroneStation"
QGC_ORG_NAME        = "FullDroneStation.org"
QGC_ORG_DOMAIN      = "org.fulldronestation"
QGC_APP_DESCRIPTION = "customgroundcontrol by client name"
QGC_APP_COPYRIGHT   = "Copyright (C) 2025 FullDroneStation Development Team. All rights reserved."
...
CustomBuild {
    ...
    DEFINES += QGC_APPLICATION_NAME=\"\\\"FullDroneStation\\\"\"
    DEFINES += QGC_ORG_NAME=\"\\\"FullDroneStation.org\\\"\"
    DEFINES += QGC_ORG_DOMAIN=\"\\\"org.fulldronestation\\\"\"
    RESOURCES += \
...
HEADERS += \
    ...
    src/QmlControls/PasswordAuthManager.h \
...
SOURCES += \
    ...
    src/QmlControls/PasswordAuthManager.cc \
